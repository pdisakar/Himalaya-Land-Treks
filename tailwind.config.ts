  ...
  theme: {
    ...
    extend: {
      backgroundImage: {
        ...
        chevron:
          "data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20fill='none'%20stroke='currentColor'%20stroke-linecap='round'%20stroke-linejoin='round'%20stroke-width='2'%20aria-hidden='true'%20class='lucide%20lucide-chevron-down%20h-4%20w-4%20shrink-0%20text-muted-foreground%20transition-transform%20duration-200'%20viewBox='5%208%2014%208'%3E%3Cpath%20d='m6%209%206%206%206-6'%3E%3C/path%3E%3C/svg%3E",
      },
      dropShadow: {
