...
export interface GlobalData {
  ...
  footer_menu?: MenuContainer; 
  canvas_menu?: string | null; 
  extra_menu?: string | null; 
}
...
export interface PackageItem {
  ...
  grade?: string | number | PackageCategory;
  style?: string | PackageCategory;
  trip_style?: string;
  destination?: { urlinfo: UrlInfo; title: string };
}
