  ...
  return (
    <div
      ...
      <figcaption className="pt-3 lg:pt-6">
        ...
        <ul className="blog-meta flex items-center flex-wrap pt-2 font-medium text-xs [&>li+li]:before:h-1 [&>li+li]:before:w-1 [&>li+li]:before:bg-current [&>li+li]:before:rounded-full [&>li+li]:before:mx-3 [&>li+li]:before:inline-flex">
          {categories && categories[0] && (
            <li>
              <Link
                href={BASE_URL + categories[0]?.urlinfo?.url_slug}
                className="underline text-primary text-muted font-medium">
