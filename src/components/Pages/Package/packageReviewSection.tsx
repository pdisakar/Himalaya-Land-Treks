...
interface PackageReviewSectionProps {
  testimonial_tripadvisor: any; // TODO: Define a more specific type if possible
  media_reels: any; // TODO: Define a more specific type if possible
  testimonial_google: any; // TODO: Define a more specific type if possible
  package_testimonials: any; // TODO: Define a more specific type if possible
  featured_testimonials: any; // TODO: Define a more specific type if possible
  testimonial_trustpilot: any; // TODO: Define a more specific type if possible
  ...
  const navItems: NavItem[] = [
    {
      ...
      icon: (
        <svg>
          <use xlinkHref={`${BASE_URL}icons.svg#tripadvisor`}  />
        </svg>
      ),
    },
    {
...
const renderIcon = (icon: React.ReactNode) => <span className="icon">{icon}</span>;

const renderLink = (platform: string, url: string, className: string, text: string) => (
    <Link
      target="_blank"
      rel="nofollow"
...
const renderDetails = (platform: string, item: NavItem) => (
...
const renderTabContent = (active: string, testimonials: any[]) => (
    <TripReviewCarousel
