...
interface TripReviewCarouselProps {
  limit?: number;
  renderData: any[];
}

export default function TripReviewCarousel({ limit, renderData }: TripReviewCarouselProps) {
              ...
              >
                <i className="icon h-2.5 w-2.5 text-secondary">
                  <svg className="-rotate-[135deg]">
                    <use xlinkHref={BASE_URL + "icons.svg#arrow-45"} />
                  </svg>
                </i>
              </div>
              <div
