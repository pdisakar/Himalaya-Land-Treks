...
interface PreviewMapProps {
  ...
  geojsonData: { features: GeoJsonDataItem[] };
}

function calculatePolylineBounds(coordinates: [number, number][]) {
...
const transformData = (data: GeoJsonDataItem[]) => {
...
const PreviewMap = ({ polylineCoordinates, mapPosition, geojsonData }: PreviewMapProps) => {
  ...
  return (
    <MapContainer
      ref={mapRef}
center={(mapRef.current as any)?._lastCenter || mapPosition}
      zoom={15}
