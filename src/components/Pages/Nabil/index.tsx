...
export default function OnlinePayment({ optionsData }: { optionsData: any }) {
                ...
                <div className="common-module bg-white shadow mb0">
                  <div className="grid grid-cols-1 gap-x-3 gap-y-6">
                    <div>
                      ...
                      {errors.package_id && (
                        <p>{String((errors.package_id as any)?.message ?? "Package is required")}</p>
                      )}
                    </div>
                    {watch("package_id") === "0" && (
                      ...
                      <div className="row g-1">
                        <div className="col-12">
                          ...
                          {errors.customer_email && (
                            <span className="invalid-feedback">
                              {String(((errors.customer_email as any)?.message) ?? "Please enter a valid email")}
                            </span>
                          )}
                        </div>
                      </div>
